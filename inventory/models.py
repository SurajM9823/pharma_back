...
class InventoryItem(models.Model):
    ...
    min_stock_level = models.PositiveIntegerField(default=10)
    max_stock_level = models.PositiveIntegerField(default=1000)
    location = models.CharField(max_length=100, blank=True, help_text="Storage location (e.g., A1-01)")
...
class BulkOrder(models.Model):
    ...
    # Stock Management
    released_date = models.DateTimeField(null=True, blank=True, help_text="When supplier released stock")
    imported_date = models.DateTimeField(null=True, blank=True, help_text="When buyer imported to stock")
    ...
    buyer_delivery_notes = models.TextField(blank=True, help_text="Buyer notes after reviewing quote")
    buyer_reconfirm_notes = models.TextField(blank=True, help_text="Buyer notes during reconfirmation")
    ...
    # Workflow control
    can_modify_items = models.BooleanField(default=True, help_text="Whether buyer can still modify items")
    supplier_locked = models.BooleanField(default=False, help_text="Supplier has locked their response")
...
class BulkOrderItem(models.Model):
    ...
    quantity_final = models.PositiveIntegerField(default=0, help_text="Final quantity after buyer reconfirmation")
    ...
    def __str__(self):
        return f"{self.product.name} - Req: {self.quantity_requested}, Conf: {self.quantity_confirmed}"
