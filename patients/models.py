...
class Patient(models.Model):
    ...
    branch_id = models.IntegerField(null=True, blank=True, help_text="Primary branch for this patient")
...
class PatientPrescription(models.Model):
    ...
    medications = models.JSONField(default=list, help_text="List of prescribed medications with dosage, frequency, etc.")
